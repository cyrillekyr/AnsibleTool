            ...
            case $target in
                ...
                2)
                    ...
                    if [[ $choice -ge 1 && $choice -le $num_groups ]]; then
                        ...
                        ansible-playbook -i "$INVENTORIES"/nodes/"$active_node"/group_vars/"$selected_group".hosts "$PLAYBOOKS"/user_management/create.yaml --extra-vars "action=deluser utilisateurs_groupes_file=$user_groups_file"
                ...
                3)
                    ...
                    #Action
                    ansible-playbook -i "$INVENTORIES"/all.hosts playbooks/user_management/create.yaml --extra-vars "action=deluser utilisateurs_groupes_file=$user_groups_file"
